...
const usingSTO = () => {
  console.log("Please work correctly!");
};
...
// -----***** onfulfilled - onrejected exercise *****_____
...
// -----*****THEN and CATCH together exercise
const {checkInventory} = require('./library.js');
...
.then((resolvedValueArray) => {
  // Write the correct return statement here: The processPayment() function should be invoked with resolvedValueArray, the anonymous function’s parameter. This will return the expected promise to the next step in the chain
 return processPayment(resolvedValueArray);
})
.then((resolvedValueArray) => {
  // Write the correct return statement here: The shipOrder() function should be invoked with resolvedValueArray, the anonymous function’s parameter. This will return the expected promise to the next step in the chain
...
// --- ***** avoid common mistakes exercise *****-----
